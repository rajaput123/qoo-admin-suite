import { Calendar, Clock, BookOpen, Store, XCircle, UserCheck, BarChart3 } from "lucide-react";
...
const navItems = [
  ...
  { label: "Cancellations & Refunds", path: "/temple/bookings/cancellations", icon: XCircle },
