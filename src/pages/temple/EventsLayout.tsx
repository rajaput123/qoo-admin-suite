import { CalendarDays, List, Calendar, LayoutTemplate, Eye, IndianRupee, BarChart3, Archive, PackageSearch } from "lucide-react";
...
const navItems = [
  ...
  { label: "Event Resources", path: "/temple/events/resources", icon: PackageSearch, description: "Resource allocation & conflicts" },
